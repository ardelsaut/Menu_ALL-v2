# Scripts Nono
# Remote Desktop Medion-Portable
# V:\03.PC\01.WINDOWS\04.COMPILATION_SCRIPTS\Menu_ALL-v2\archives\Scripts\RemoteDesktop\Medion-Portable.ps1
# For more info about he settings
# https://www.donkz.nl/overview-rdp-file-settings/

Clear-Host
$shortcutNameps1 = "Medion-Portable"
$shortcutName = "Medion-Portable"
$targetHost = "nonobouli.myds.me:3391"
$username = "Nono"
